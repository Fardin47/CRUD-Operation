...
urlpatterns = [
    ...
    path('delete/<int:id>/', views.employee_delete,name='employee_delete'), # delete a record
    path("list/", views.employee_list,name='employee_list'), # get request to retreive and display all records
]
